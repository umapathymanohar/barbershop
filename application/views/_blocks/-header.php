...
<html>
    <head>
        ...
        <link href="/barbershop/assets/css/lavish-bootstrap.css" rel="stylesheet" media="screen">
        <link href="/barbershop//netdna.bootstrapcdn.com/font-awesome/4.0.1/css/font-awesome.css" rel="stylesheet">
        <link href="/barbershop/assets/css/sticky-footer-navbar.css" rel="stylesheet">  
        <link href='http://fonts.googleapis.com/css?family=Quattrocento+Sans' rel='stylesheet' type='text/css'>
        <link href="/barbershop/assets/css/styles.css" rel="stylesheet">
        <!--[if lt IE 9]>
